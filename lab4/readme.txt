...
Complexity:
Taking n as the size of the interval for find the answer the complexity of the brute force algorithm is O(n^2), complexity O(n) to evaluate the function in the interval and complexity O(n)
